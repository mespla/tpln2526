...
- Assignments before the class of Dec 12, 2025: Read the materials related to feedforward neural networks and transformers, linked in this [section](text.md#before-text2) and then complete [this test](https://forms.gle/7KDwRtXcrpxsKjHp7) (deadline: 23:59 CET, Dec 11 2025).
...
[syllabus]: https://cvnet.cpd.ua.es/Guia-Docente/GuiaDocente/Index?wlengua=es&wcodasi=43505&scaca=2025-26
...
[source]: https://github.com/mespla/tpln2526

You can obtain a local copy of these pages (e.g., for offline access) by executing:

    wget --mirror --no-parent --convert-links --page-requisites https://mespla.github.io/tpln2526
