...
## First session of this module (January 14, 2026)

### Contents to prepare before the session on Jan 14 {#before-speech1}
...
### Contents for the in-person session on Jan 14
